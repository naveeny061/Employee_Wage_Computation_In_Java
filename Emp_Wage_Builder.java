...
public class Emp_Wage_Builder {
	...
	Emp_Wage_Builder(String Company_name, int Emp_Rate_Per_Hour, int Emp_Number_Of_Working_Days,
			int Max_Hours_Per_Month) {
	...
	public static void main(String arg[]) {
		...
		Emp_Wage_Builder obj1 = new Emp_Wage_Builder(Company_Name, Emp_Rate_Per_Hour, Emp_Number_Of_Working_Days,
				Max_Hours_Per_Month);
